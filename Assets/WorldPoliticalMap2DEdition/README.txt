...
Version 10.1
- Added shadows receiving support in URP

Version 10.0
- Minimum Unity version required is now 2021.3.16
- Internal fixes and improvements

Version 9.0
- Added 2 new demo scenes showcasing map in 2D mode (screen overlay mode and native UI mode)
- Added "Blocking Mask" option for "Respect Other UI"

Version 8.1
- Added "Map Panel" component for native UI mode

Version 8.0
  - Added "Pointer Source" option under Interaction section
  - Added demo scene 6 "Custom Ray Interaction"
  - API: BlinkCountry now covers all country regions
  - API: BlinkCountryMainRegion will blink the main region of a country only
...
Version 7.8.2
  - Setting a region color now accepts transparent colors
  - [Fix] Fixed region color issue when previously used HideCountrySurfaces() method

Version 7.7 11/Apr/2022

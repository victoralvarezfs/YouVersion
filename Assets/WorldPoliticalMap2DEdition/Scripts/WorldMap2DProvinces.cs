...
namespace WPMF {
    ...
    public partial class WorldMap2D : MonoBehaviour {
        ...
        /// Returns the index of a province in the global provinces array.
        /// </summary>
        public int GetProvinceIndex(string provinceName, string countryName) {
        ...
        /// </summary>
        public void ToggleProvinceSurface(string provinceName, string countryName, bool visible, Color color = default(Color)) {
            int provinceIndex = GetProvinceIndex(provinceName, countryName);
        ...
        public GameObject ToggleProvinceRegionSurface(int provinceIndex, int regionIndex, bool visible, Color color) {
            ...
            if (surfaces.TryGetValue(cacheIndex, out surf) && surf != null) {
                ...
                surf.GetComponent<Renderer>().sharedMaterial = coloredMat;
            } else {
                surf = GenerateProvinceRegionSurface(provinceIndex, regionIndex, coloredMat);
            }

...
namespace WPMF {
    ...
    public delegate Ray PointerRayProviderDelegate();
    ...
    public partial class WorldMap2D : MonoBehaviour {
		...
		[SerializeField]
		PointerSource _pointerSource = PointerSource.Mouse;

		public PointerSource pointerSource {
			get { return _pointerSource; }
			set { if (_pointerSource != value) {
					_pointerSource = value;
					isDirty = true;
				}
			}
		}
		...
		/// <summary>
		/// Optional user ray provider for interaction
		/// </summary>
		public PointerRayProviderDelegate pointerRayProvider;

...
namespace WPMF
{
	...
	public class WorldMap2D_EditorInspector : Editor
	{
		...
		void OnEnable ()
		{
			...
			mainToolbarIcons [1] = new GUIContent ("Edit", icons [1], "Edit the shape of this entity or delete selection");
		...
		void ExecuteMoveTool ()
		{
			...
			for (int i = 0; i < points.Length; i++) {
				...
				var fmh_1359_50_638865333270480038 = mapTransform.rotation; newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
		...
		void ExecuteCityMoveTool ()
		{
			...
			var fmh_1542_57_638865333270509693 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
			                                           (handleControlID, position, rotation, size, eventType) =>
			                                           {
		...
		void ExecuteMountPointMoveTool ()
		{
			...
			var fmh_1631_57_638865333270515152 = mapTransform.rotation; Vector3 newPoint = Handles.FreeMoveHandle (oldPoint, handleSize, pointSnap,   
			                                           (handleControlID, position, rotation, size, eventType) =>
			                                           {
				Handles.RectangleHandleCap (handleControlID, position, rotation, size, eventType);
			});
